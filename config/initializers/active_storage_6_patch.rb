...
module ActiveStorage
  ...
  class Service::AzureStorageService < Service
    ...
    def initialize(storage_account_name:, storage_access_key:, container:, public: false, **options)
      @client = Azure::Storage::Blob::BlobService.create(storage_account_name: storage_account_name,
                                                         storage_access_key: storage_access_key, **options)
    ...
    def headers_for_direct_upload(_key, content_type:, checksum:, filename: nil, disposition: nil, **)
      ...
      { 'Content-Type' => content_type, 'Content-MD5' => checksum,
        'x-ms-blob-content-disposition' => content_disposition, 'x-ms-blob-type' => 'BlockBlob' }
    end
